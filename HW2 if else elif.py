...
#  item_4=0, поэтому будет выведено условие else
if item_4:
...
#  то выполнять следующие шаги задания, иначе, вывести в консоль (“Переменная currency_convertor = ”, item_3)
if currency_convertor:
    ...
    if target_currency =='eur':
       ...
       print(target_currency_amount, uah_item, "=", currency_result, usd_item)
        ...
        print(target_currency_amount, chf_item, "=", currency_relult, usd_item)
    elif target_currency =='rub':
        currency_result = target_currency_amount / usd_rub_rate
        print(target_currency_amount, rub_item, "=", currency_relult, usd_item)
...
#                  при target_currency_amount и usd_eur_rate. Результат вывести
...
#                     получится при target_currency_amount и usd_uah_rate. Результат вывести
